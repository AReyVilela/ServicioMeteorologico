...
import servicio.ServicioClimatologia;
import utilidad.PrintUtil;
...
//METODOS A LLAMAR EN EL MAIN
    private static void imprimirInformeMeteorologico() {

        System.out.println("DATOS METEOROLÓGICOS DEL DÍA 31 DE OCTUBRE DE 2022");
        System.out.println("**************************************************\n\n");
        maximaYMinimaTotal();
        maximaPorProvincias();
        minimaPorProvincias();
